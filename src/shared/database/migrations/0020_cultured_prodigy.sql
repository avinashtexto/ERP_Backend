...
--> statement-breakpoint
ALTER TABLE "admin_sessions" ALTER COLUMN "session_id" SET GENERATED BY DEFAULT;--> statement-breakpoint
ALTER TABLE "user_sessions" ALTER COLUMN "session_id" SET GENERATED BY DEFAULT;--> statement-breakpoint
